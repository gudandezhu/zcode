...
import type { Artifact, Reaction } from "@zcode/shared";
...
export const tasks = sqliteTable("tasks", {
  ...
  artifacts: text("artifacts", { mode: "json" }).$type<Artifact[]>().notNull().default([]),
...
export const discussionMessages = sqliteTable("discussion_messages", {
  ...
  reactions: text("reactions", { mode: "json" }).$type<Reaction[]>().notNull().default([]),
